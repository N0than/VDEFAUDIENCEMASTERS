/*
  # Update weekly leaderboard to use predictions_with_accuracy view

  1. Changes
    - Drop existing weekly leaderboard view
    - Create new view using predictions_with_accuracy
    - Add proper week calculation
...
-- Create improved view for weekly leaderboard using predictions_with_accuracy
